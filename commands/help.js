...
const helpEmbed = new Discord.RichEmbed()
    ...
    .addField('.dailyword', 'Become more big brain by getting the daily word from Wordnik')
    .addField('.scrabble', 'Compete against others in a 8-round Scrbble-like game and earn the highest score.')
    .addField('.blackjack', 'Test your luck with Blackjack (WIP, probably will not be finished in a while)')
    .addField('---------------------------------------------', '** **')
